...
const AddShows = () => {
    ...
    const fetchNowPlayingMovies = async () => {
        // setNowPlayingMovies(dummyShowsData), comment this because now we'll add data directly using api
        try{
    ...
    return nowPlayingMovies.length > 0 ? (
        <>
            ...
            <div className='mt-8'>
                ...
                <div className='inline-flex items-center gap-2 border borer-gray-600 px-3 py-2 rounded-md'>
