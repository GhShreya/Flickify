...
const Navbar = () => {
    ...
    return (
        <div className='fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5'>
            ...
            {/* /*next div is for menu items, we'll use link tag to make it clickable*/
            /* max-md is used for small screen and md for medium */
            /* backdrop-blur is glassmorphism and 300/20 is gray(300) at 20% opacity and transition only width property for 300ms*/}
            ...
            overflow-hidden transition-[width] duration-300 ${isOpen ? 'max-md:w-full' : 'max-md:w-0'}`}>
                ...
                <XIcon className='md:hidden absolure top-6 right-6 w-6 h-6 cursor-pointer'
                onClick={() => setIsOpen(!isOpen)}/> {/* cross button for menu for small screen, onClick it toggles*/}
            ...
            <div className='flex items-center gap-8'>  {/* for search and login */} 
